...
\usepackage[orientation=portrait,size=a0,scale=1.1]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size
...
\message{ !name(poster2.tex) !offset(-3) }
...
\message{ !name(poster2.tex) !offset(-5) }
