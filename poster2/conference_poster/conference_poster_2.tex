...
\usepackage[orientation=landscape,size=a0,scale=1.1]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size
