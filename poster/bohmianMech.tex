...
The purpose of the current project will be to resolve the following apparent paradox. There's a test called ``the GHZ test''. This test claims to prove that variables can't have predefined values. 
