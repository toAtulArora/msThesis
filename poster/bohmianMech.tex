...
Such a theory is worth studying because the following are at stake. (1) Clarity: The widely held notion that at the atomic level, we must give up any concievable precise description of nature, is plain false because there exists a counter example. (2) Accuracy of conclusions: The class of theories which are ruled out by \\
