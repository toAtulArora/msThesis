...
This paradox has not been studied yet and it is particularly interesting for if BM is unable to predict the QM result, then we'd know at once BM is wrong. If BM does predict the QM result, we'd know that the claim made by the GHZ state, must be restricted.
}
